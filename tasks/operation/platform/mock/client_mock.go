...
import (
	...
	constant2 "github.com/sambaiz/cdkbot/tasks/operation/constant"
	platform2 "github.com/sambaiz/cdkbot/tasks/operation/platform"
	"reflect"
)
...
func (m *MockClienter) ListComments(ctx context.Context) ([]platform2.Comment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListComments", ctx)
	ret0, _ := ret[0].([]platform2.Comment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClienter) AddLabel(ctx context.Context, label constant2.Label) error {
	m.ctrl.T.Helper()
...
func (m *MockClienter) AddLabelToOtherPR(ctx context.Context, label constant2.Label, number int) error {
	m.ctrl.T.Helper()
...
func (m *MockClienter) RemoveLabel(ctx context.Context, label constant2.Label) error {
	m.ctrl.T.Helper()
...
func (m *MockClienter) GetPullRequest(ctx context.Context) (*platform2.PullRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPullRequest", ctx)
	ret0, _ := ret[0].(*platform2.PullRequest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClienter) GetOpenPullRequests(ctx context.Context) ([]platform2.PullRequest, error) {
	m.ctrl.T.Helper()
...
func (m *MockClienter) SetStatus(ctx context.Context, state constant2.State, description string) error {
	m.ctrl.T.Helper()
